              ...
              <div className="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1">
                <div className={welcomecss.s10}>
                  <h1>
                    ...
                    Edition du Forum Virtuel de L’Université Ibn Tofail
                  </h1>
                  <h5>Sous le thème</h5>
                  <h2>
                    Le rôle du digitale à l’université pour une meilleur
                    ouverture des lauréats & étudiants
                  </h2>
                  <div className={welcomecss.dlgflex}>
                    <a href="#about" className={welcomecss.btngetstarted}>
                      Plus de détails
                    </a>
                    <a
          ...
          <div className="container" data-aos="fade-up">
            ...
            <div className="row">
              ...
              <div className="col-lg-6 pt-3 pt-lg-0 content">
                ...
                <p>
                  La première édition du Forum Virtuel de l’Université Ibn
                  Tofail est l’occasion de rapprocher le monde académique au
                  monde professionnel, ainsi contribuer à renforcer le rôle de
                  l’université dans son environnement.
                </p>
                <p>
                  Cette organisation en mode virtuel, est un témoignage de
                  l’adoption de l’université des moyens digital pour à la fois
                  faciliter aux entreprises et l’étudiant cette rencontre, qui
                  pourrait être une préparation aux versions présentielles
                  organisées par les différents établissements de l’Université
                  Ibn Tofail.
                </p>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-md-6 col-lg-3">
                <div className="footer-contact">
                  ...
                  <hr />
                  <p className="pp">
                    Le Forum Annuel Virtuel De L’Université Ibn Tofail est d’une
                    part un moment d’échange et d’ouverture de l’université sur
                    son environnement régional et national, puis d’autre part,
                    c’est un moment ou le lauréat et étudiant se positionne et
                    se projette.
                  </p>
                </div>
              </div>
              <div className="col-md-6 col-lg-3">
                <div className="footer-link">
                  <h2>Allez </h2>
                  <a href="">
                    <i class="fas fa-caret-right"></i>Accueil
                  </a>
                  <a href="">
                    <i class="fas fa-caret-right"></i>A propos
                  </a>
                  <a href="">
                    <i class="fas fa-caret-right"></i>Partenaires
                  </a>
                  <a href="">
                    <i class="fas fa-caret-right"></i>Contactez-nous
                  </a>
                </div>
              </div>
              <div className="col-md-6 col-lg-3">
                <div className="footer-link">
                  <h2>Liens utiles</h2>
                  <a href="">
                    <i class="fas fa-caret-right"></i>Université IBN tofail{" "}
                  </a>
                  <a href="">
                    <i class="fas fa-caret-right"></i>ENSA- KENITRA
                  </a>
                  <a href="">
                    <i class="fas fa-caret-right"></i>ENCG- KENITRA
                  </a>
                  <a href="">
                    <i class="fas fa-caret-right"></i>FSJES- KENITRA
                  </a>
                </div>
              </div>
              <div className="col-md-6 col-lg-3">
                <div className="footer-contact">
                  ...
                  <p>
                    <i className="fa fa-map-marker-alt"></i>&nbsp;Campus
                    universitaire, B.P 241, Kénitra - 14 000 - Maroc
                  </p>
                  <p>
                    <i className="fa fa-phone-alt"></i>&nbsp;+212 6 29 10 21 64
                  </p>
                  <p>
          ...
          <div className="container copyright">
            <div className="row">
              <div className="col-md-6">
                <p>
                  &copy; <a href="#">2021 FORUM Université IBN TOFAIL</a>. Tous
                  droits réservés
                </p>
              </div>
            </div>
