  ...
  return (
    <section className="resume-section m-0" id="skills">
      <div className="resume-section-content">
              ...
              {dev?.map((e) => (
                <div className="col-sm-3 mr-4 d-block mb-2">
                  <Box component="fieldset" mb={3} borderColor="transparent">
                    <Typography
                      component="legend"
                      className="d-flex align-items-center space-between flex-nowrap justify-content-start"
                    >
                      <i className={e.icon + " fa-2x"} />
                      <span className="ml-2">{e.name}</span>
                    </Typography>
                    <Rating
                      readOnly
                      name="customized-10"
                      defaultValue={e.value / 2}
                      max={5}
                    />
                  </Box>
                </div>
        ...
        {software.length != 0 && (
          <>
            <div className="subheading mb-3 mt-3">Softwares</div>
            <div className="d-flex flex-row" style={{ flexWrap: "wrap" }}>
              {software?.map((e) => (
