    ...
    <div className={styles.sidebar}>
      <div className={styles.sidebar_stats}>
        ...
        <div className={styles.sidebar_stat}>
          <p>
            <PeopleIcon /> <span> Connections</span>
          </p>
          <p className={styles.sidebar_statNumber}>
            {user?.friendshipSended.length + user?.friendshipReceived.length}
          </p>
        </div>
        <div className={styles.sidebar_stat}>
          <p>
            <VisibilityIcon /> <span> Profile's views</span>
          </p>
          <p className={styles.sidebar_statNumber}>{profileViews}</p>
        </div>
        <div className={styles.sidebar_stat}>
          <p>
            <PersonAddSharpIcon />
        ...
        <div className={styles.sidebar_stat}>
          <p>
            <PeopleSharpIcon /> <span>Groups</span>
          </p>
          <p className={styles.sidebar_statNumber}>
            {Math.floor(Math.random() * 20)}
          </p>
